...
type AwardBeltModalProps = {
  ...
  currentUserBelt: BJJBelt | null; // Current belt of the user trying to award
...
export function AwardBeltModal({ isOpen, onClose, promotedByProfileId, currentUserBelt, onSuccess }: AwardBeltModalProps) {
  ...
  // Prevent white belts from awarding belts
  if (currentUserBelt === 'White') {
    return (
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
          <div className="mt-3 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-2">Access Denied</h3>
            <p className="text-sm text-gray-500 mt-2">
              White belts cannot award belts to other practitioners. You need to be promoted to a higher rank first.
            </p>
            <div className="mt-4">
              <button
                onClick={onClose}
